...
import { AlertCircle, Plus, Edit, Trash2, Package, Search, Filter, Wrench, Tag, FileText, Hash, MapPin, TrendingDown } from 'lucide-react';
...
export default function IndividualTools() {
  ...
  const loadTools = async () => {
    try {
      ...
      if (data.success) {
        // Filter only individual tools
        const individualTools = data.tools.filter((tool: Tool) => tool.type === 'individual');
        setTools(individualTools);
      } else {
  ...
  const loadCategories = async () => {
    try {
      const response = await fetch('/api/categories/type/individual');
      if (!response.ok) {
  ...
  const handleCreateTool = async () => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess('Herramienta individual creada exitosamente');
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Gestiona herramientas asignadas individualmente a operarios
            </p>
          </div>
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            <DialogTrigger asChild>
              <Button style={{ backgroundColor: '#E2372B' }}>
                ...
                Nueva Herramienta Individual
              </Button>
            </DialogTrigger>
            <DialogContent className="max-w-lg">
              <DialogHeader>
                <DialogTitle>Crear Nueva Herramienta Individual</DialogTitle>
                <DialogDescription>
                  Agrega una nueva herramienta para asignación individual
                </DialogDescription>
              </DialogHeader>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-8 text-gray-500">
                No se encontraron herramientas individuales.
              </div>
            ) : (
              <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-2">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                <AlertDialogTitle>¿Eliminar herramienta individual?</AlertDialogTitle>
                                <AlertDialogDescription>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle>Editar Herramienta Individual</DialogTitle>
              <DialogDescription>
